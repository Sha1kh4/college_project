        ...
        <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
                <a href="index.html" class="navbar-brand d-flex align-items-center text-center py-0 px-4 px-lg-5">
                    <h1 class="m-0 text-primary">MIT</h1>
                </a>
                ...
                <div class="container">
                    ...
                    <div class="row g-4">
                            ...
                            <div class="row gy-4">
                                <div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="d-flex align-items-center bg-light rounded p-4">
                                        ...
                                        <span>MIT,Aurangabad,Maharashtra,India</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <iframe
                                src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Maharashtra%20Institute%20Of%20Technology,Beedbypass%20,Aurangabad+(MIt)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                                width="530" height="470" style="border:0;" allowfullscreen="" loading="lazy"
...
$username = 'root';
$password = '';
$successMessage = '';  // Replace with your MySQL password
