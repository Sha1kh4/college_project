                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">MIT</a>, All Right Reserved. Designed By <a class="border-bottom" href="https://github.com/Sha1kh4">SKAD</a>
                        </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $batch = $_POST['batch'];
            $branch = $_POST['branch'];
            $phone = $_POST['phone']; // Retrieve the phone number value

            // Prepare and execute the SQL query
            $query = "INSERT INTO admissions (name, email, batch, branch, phone) VALUES (?, ?, ?, ?, ?)";
            $stmt = $pdo->prepare($query);
            $stmt->execute([$name, $email, $batch, $branch, $phone]);
